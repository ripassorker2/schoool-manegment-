...
const UpdateRoutine1to3 = ({ routine, setOpenModal }) => {
   ...
   const handleSubmit = (e) => {
      ...
      const updatedClass = {
         class: routine.class,
         saturday: [saturdayFrist, saturdaySecond, saturdayThird],
         sunday: [sundayFrist, sundaySecond, sundayThird],
         monday: [mondayFrist, mondaySecond, mondayThird],
         tuesday: [tuesdayFrist, tuesdaySecond, tuesdayThird],
         wednesday: [wednesdayFrist, wednesdaySecond, wednesdayThird],
         thursday: [thursdayFrist, thursdaySecond, thursdayThird],
      };
...
export default UpdateRoutine1to3;
